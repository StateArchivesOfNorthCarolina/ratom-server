# Generated by Django 2.2.8 on 2020-01-23 14:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('AR', 'Archivist'), ('RE', 'Researcher')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('import_status', models.CharField(choices=[('CR', 'Created'), ('IM', 'Importing'), ('CM', 'Complete'), ('FA', 'Failed')], default='CR', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('U', 'User'), ('I', 'Importer'), ('S', 'S')], max_length=1)),

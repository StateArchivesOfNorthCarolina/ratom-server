# Generated by Django 2.2.7 on 2020-01-20 17:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(core.models.UserTypeEnum('Archivist'), 'Archivist'), (core.models.UserTypeEnum('Researcher'), 'Researcher')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('import_status', models.CharField(choices=[(core.models.FileImportStatus('Created'), 'Created'), (core.models.FileImportStatus('Importing'), 'Importing'), (core.models.FileImportStatus('Complete'), 'Complete'), (core.models.FileImportStatus('Failed'), 'Failed')], default=core.models.FileImportStatus('Created'), max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[(core.models.TagTypeEnum('User'), 'User'), (core.models.TagTypeEnum('Importer'), 'Importer'), (core.models.TagTypeEnum('Static'), 'Static')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('redactions', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='core.Redaction')),
                ('restrictions', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='core.RestrictionAuthority')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Account')),
                ('audit', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.MessageAudit')),
                ('file', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.File')),
            ],
        ),
        migrations.CreateModel(
            name='HistoricalMessageAudit',
            fields=[
                ...
                ('redactions', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.Redaction')),
                ('restrictions', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.RestrictionAuthority')),
            ...
            options={
                'verbose_name': 'historical message audit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload', models.FileField(upload_to=core.models.upload_directory_path)),

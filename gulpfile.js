...
var options = {
  src: './ratom_api/static/js/index.js',
  dest: './ratom_api/static/js/',

  modernizr: {
    src: './ratom_api/static/js/index.js',
    dest: './ratom_api/static/libs/',
  },

  css: {
    src: './ratom_api/static/less/index.less',
    watch: './ratom_api/static/less/**/*.less',
    dest: './ratom_api/static/css/'
  },
  development: false
}
...
gulp.task('test', gulp.series(function () {
  ...
  return gulp
    .src('./ratom_api/static/js/app/**/*.js')
    .pipe(istanbul({
    ...
    .on('finish', function () {
      gulp
        .src('./ratom_api/static/js/test/**/test_*.js', {read: false})
        .pipe(mocha({
          require: [
